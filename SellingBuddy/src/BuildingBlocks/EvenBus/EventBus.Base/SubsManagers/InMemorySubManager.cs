...
{
    public class InMemorySubManager : IEventBusSubscriptionManager
    {
        ...
        public InMemorySubManager(Dictionary<string, List<SubscriptionInfo>> handlers, List<Type> eventTypes, Func<string, string> eventNameGetter)
        {
            _handlers = handlers;
...
where T : IntegrationEvent
        ...
        private SubscriptionInfo FindSubscriptionInfo(string eventName, Type handlerType)
        {
            if (!HasSubscriptionsForEvent(eventName))
            {
                return null;
